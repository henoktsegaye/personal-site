      ...
      <div className=" grid xl:grid-cols-6  grid-cols-3 items-center justify-between ">
        <div className="col-span-3  text-left 2xl:py-12 py-4 pl-4">
          <h1 className=" leading-normal font-normal align-middle  text-black dark:text-gray-600">
            <span className="text-5xl mb-8 block text-gray-600">
              {" "}
              {title?.intro}{" "}
            </span>
            ...
            <div className="mt-2 text-4xl block text-gray-600">
              {title?.secondIntro}{" "}
              <span className="font-bold text-gray-900 dark:text-white uppercase text-3xl">
                {title?.title1}
              </span>
            </div>
            <span className="text-4xl mt-4 mb-4 inline-block text-gray-600">
              {" "}
              {title?.thirdIntro}{" "}
            </span>
          ...
          <a
            ...
            className="mt-4 align-middle hover:text-blue-700 text-blue-600 dark:text-blue-300 cursor-pointer inline-block bg-red-100 dark:bg-gray-700  py-2 pl-4 pr-6 rounded-lg text-lg"
          >
            <DownloadIcon
              width={24}
              height={24}
              className="fill-current inline-flex mr-2 hover:text-blue-700 text-blue-600 dark:text-blue-300"
            />
            Download CV
          </a>
        </div>
