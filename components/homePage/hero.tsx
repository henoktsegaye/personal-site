      ...
      <div className=" grid xl:grid-cols-6 grid-cols-3 items-center">
        <div className="col-span-3">
          ...
          <img
            ...
            className="w- left-0 text-left justify-items-start"
            alt=""
          />
          </div>
        </div>
        ...
        <div className="col-span-6 mt-10   border-2 border-gray-100 dark:border-gray-900 py-6 px-4 rounded-xl lg:mt-0">
