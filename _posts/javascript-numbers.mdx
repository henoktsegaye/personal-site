---
date: "2022-09-05"
thumbnail: /assets/javascript-numbers.png
title: Javascript number types
description: Javascript number types
hashtag: Javascript
---
Welcome to the **Understanding Javascript basics** series. On this blog we will try to look into one of primitive types in Javascript ***Number** 
